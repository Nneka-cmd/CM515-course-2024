...
[Exploring historic, current and projected population data across countries on infant mortality and birth rate from 1950 to 2100](https://ourworldindata.org/population-growth)
...
#Explore infant_mortality and birth rate
...
income_levels <- population_data %>%
  subset(Country.name == c("High-income countries","Lower-middle-income countries", "Low-income countries"))
```
